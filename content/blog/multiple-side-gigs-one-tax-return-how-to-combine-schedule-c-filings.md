---
layout: post.njk
title: "Multiple Side Gigs, One Tax Return: How to Combine Schedule C Filings"
description: "Running an Etsy shop and driving for Uber? Here's exactly how the
  IRS wants you to report multiple side hustles — separate Schedule Cs, one
  combined Schedule SE, and the rules most people get wrong. "
date: 2026-07-15T00:41:00.000+08:00
keyword: "multiple side hustles one tax return, how to file taxes with multiple
...
1. **Each business's income and expenses** go on its own Schedule C, resulting in a net profit or loss per business
2. **All Schedule C net results combine** into one Schedule SE, which calculates your total self-employment tax (15.3% on your combined net earnings, up to the Social Security wage base)
3. **Both Schedule C net amounts flow to Schedule 1, Line 3** on your Form 1040, combined
4. **The deductible half of your self-employment tax** (calculated on Schedule SE) becomes an adjustment to income on Schedule 1

## Frequently Asked Questions

**Do I need to file quarterly estimated taxes separately for each side hustle?** No — quarterly estimated tax payments are based on your total expected tax liability for the year across all income sources combined (side hustles plus any W-2 withholding), not calculated or paid separately per gig. Use our [Side Hustle Tax Calculator](https://monetools.com/tools/side-hustlers/side-hustle-tax-calculator) to estimate your combined quarterly payment amount.
