...
It's also a timing acceleration, not a permanent tax reduction — every dollar of depreciation claimed this year reduces what's available in future years, and increases the depreciation recapture liability they'll face if they eventually sell (see our related article on [the depreciation recapture trap](https://claude.ai/blog/depreciation-mistake-landlords-thousands/)).
