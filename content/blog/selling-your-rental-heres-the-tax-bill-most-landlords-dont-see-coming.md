---
layout: post.njk
title: Selling Your Rental? Here's the Tax Bill Most Landlords Don't See Coming
description: "Selling a rental triggers three separate taxes most landlords only
  discover at closing: depreciation recapture, capital gains, and possibly NIIT.
  Here's how they stack, with a full worked example. "
date: 2026-07-30T23:52:00.000+08:00
keyword: "taxes when selling rental property, depreciation recapture capital
  gains NIIT, how much tax do I owe selling rental, landlord sell property tax
  calculator "
audience: landlords
related_tool: Sell vs Keep Calculator (/tools/landlords/sell-vs-keep-calculator.html)
tags:
  - blog
---
...
**Layer 1: Depreciation Recapture.** Every year you owned the property, depreciation reduced your taxable rental income — or should have, whether you claimed it or not (see our related article on [the depreciation recapture trap](https://claude.ai/blog/depreciation-mistake-landlords-thousands/)). At sale, that cumulative depreciation is taxed separately as "unrecaptured Section 1250 gain," at a rate capped at 25% — this portion is taxed first, before the remaining gain moves to capital gains treatment.
...
Run your specific numbers, including your actual depreciation history and expected sale price, through our [Sell vs Keep Calculator](https://claude.ai/tools/landlords/sell-vs-keep-calculator.html) to see this full three-layer calculation applied to your situation before you list.
...
**Is depreciation recapture calculated the same way for a short-term rental as a long-term rental?** Yes — recapture applies based on depreciation claimed or allowable regardless of whether the property was operated as a long-term rental or short-term rental, and regardless of whether you used the STR loophole to offset active income during ownership (see our related article on [the STR loophole](https://claude.ai/blog/str-loophole-explained-material-participation/)). Using accelerated depreciation through cost segregation during ownership generally increases your recapture exposure at sale, since more depreciation was claimed overall.
